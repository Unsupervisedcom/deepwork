...
- `hooks_system.md` (from step `research`)
  Location: `deepwork/add_platform/hooks_system.md`
...
- `deepwork/add_platform/job_schema.py`- `deepwork/add_platform/adapters.py`
...
1. **Commit your work**:
   ...
   git commit -m "add_platform: Complete add_capabilities step"
   ```
