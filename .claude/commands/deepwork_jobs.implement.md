...
**Complete example**: See `.deepwork/jobs/deepwork_jobs/templates/example_step_instruction.md` for a fully worked example.
...
- **Job specification**: `.deepwork/jobs/deepwork_jobs/templates/example_job.yml`
- **Step instruction**: `.deepwork/jobs/deepwork_jobs/templates/example_step_instruction.md`
