---
description: Analyze the company profile to identify pain points and workflows where DeepWork would add value
---

# founder_outreach.analyze

**Step 2 of 3** in the **founder_outreach** workflow
...
2. **Inform the user**:
   ...
   - Outputs created: deepwork_fit_analysis.md
   - Ready to proceed to next step: `/founder_outreach.outreach`
...
- Step instructions: `.deepwork/jobs/founder_outreach/steps/analyze.md`