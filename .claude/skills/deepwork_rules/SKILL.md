...
2. If on a `deepwork/deepwork_rules-*` branch: continue using it
3. If on main/master: create new branch `deepwork/deepwork_rules-[instance]-$(date +%Y%m%d)`
...
- define instructions: `.deepwork/jobs/deepwork_rules/steps/define.md`
