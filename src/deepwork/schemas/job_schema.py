...
# Schema for a workflow (a named group of steps)
WORKFLOW_SCHEMA: dict[str, Any] = {
    ...
    "properties": {
        "name": {
            "type": "string",
            "minLength": 1,
            "description": "Workflow name (optional - omit for standalone/anonymous workflows)",
        },
        "description": {
            "type": "string",
            "minLength": 1,
...
JOB_SCHEMA: dict[str, Any] = {
    ...
    "type": "object",
    "required": ["name", "version", "summary", "workflows"],
    "properties": {
        "name": {
            "type": "string",
            "pattern": "^[a-z][a-z0-9_]*$",
        ...
        "workflows": {
            "type": "array",
            "minItems": 1,
            "description": "List of workflows in the job. Each workflow contains one or more steps.",
