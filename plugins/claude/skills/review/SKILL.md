...
Subsequent runs automatically skip reviews that already passed — the reviewing agents call `mark_review_as_passed` after a clean review, and those reviews are excluded as long as the reviewed files remain unchanged.
