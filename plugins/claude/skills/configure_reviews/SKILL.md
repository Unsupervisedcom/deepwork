...
5. Test your change. Make a small change that should trigger the affected rule, then call `mcp__deepwork__review` and verify that the output includes text referencing your new rule. Be sure to revert the change.
