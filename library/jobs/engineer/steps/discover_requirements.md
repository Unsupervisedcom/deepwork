...
1. Read the project's agent context file. Look for a `## Requirements` section or
   any mention of a requirements directory path.
...
- **User intent**: create, amend, or reorganize
- **Target requirements**: which requirement IDs will be created or modified
