...
trigger: manual_tests/claude/test_command_action.txt
action:
  command: echo "$(date '+%Y-%m-%d %H:%M:%S') - Command triggered by edit to {file}" >> manual_tests/claude/test_command_action_log.txt
  run_for: each_match
---
