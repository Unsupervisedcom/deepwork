...
trigger: manual_tests/claude/test_multi_safety.py
safety:
  - manual_tests/claude/test_multi_safety_changelog.md
  - manual_tests/claude/test_multi_safety_version.txt
---
...
1. Update the changelog: `manual_tests/claude/test_multi_safety_changelog.md`
2. And/or update the version: `manual_tests/claude/test_multi_safety_version.txt`
