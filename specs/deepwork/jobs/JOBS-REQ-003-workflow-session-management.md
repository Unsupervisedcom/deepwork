...
### JOBS-REQ-003.19: Step Navigation (go_to_step)
...
9. `go_to_step()` MUST update `current_entry_index` to the provided `entry_index`.
10. `go_to_step()` MUST persist the session after modification.
